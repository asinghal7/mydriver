...
static int my_open(struct inode *inode, struct file *file)
{
        ...
        /*
         * There might be an issue in case write is requested on the same device
         * by separate processess. It might truncate the file (my_trim) while the 
         * second process is not finished writing.
